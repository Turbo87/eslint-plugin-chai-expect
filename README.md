...
:warning: The recommended configuration for the eslint legacy configuration system (`.eslintrc.json`) was renamed to `recommended-legacy`. The `recommended` configuration is for the new flat configuration system.
...
```json
{
  "extends": ["plugin:chai-expect/recommended-legacy"]
}
```
